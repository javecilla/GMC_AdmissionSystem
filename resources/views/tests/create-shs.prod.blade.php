<x-app-layout title="Admission - SHS">
  ...
  <x-section class="bg-white mb-3 ">
	  <img src="{{ asset('/wp-content/uploads/header6.PNG') }}"
  ...
  {{-- Custom Scripts --}}
<script src="{{ asset('/wp-content/themes/scripts/helper.min.js?v=1.0') }}"></script>
<script src="{{ asset('/wp-content/themes/scripts/formValidations.min.js?v=1.0') }}"></script>
<script src="{{ asset('/wp-content/themes/scripts/app.min.js?v=1.0') }}"></script>
</x-app-layout>
