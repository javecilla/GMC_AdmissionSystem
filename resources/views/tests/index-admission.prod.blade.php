<x-app-layout title="Admission">
  ...
  {{-- Hero card --}}
	<x-section class="bg-white mb-3 ">
	  <img src="{{ asset('/wp-content/uploads/index_banner.PNG') }}"
  		...
  		<div class="row flex-lg-row-reverse">
  			...
  			<div class="col-md-6 mb-3">
  				<x-card class="card_box border-0 rounded-4">
  					<img src="{{ asset('/wp-content/uploads/shs_card.PNG') }}"
  					...
  					<div class="card-body" style="margin-top: -30px;">
					    ...
					    <div class="d-flex justify-content-center align-items-center">
								<div class="buttons text-center">
									<a href="{{ url('https://www.goldenmindsbulacan.com/academics/senior-high-school') }}"
									target="_blank" title="Read more information about GMC-SHS" class="btn btn-light back_button mt-2">
							  		{{ __('Read More Info') }}
			 						</a>&nbsp;
								 	<a href="{{ url('https://admission.goldenmindsbulacan.com/senior-high-school/registration?step=1&form_mode=applying-for') }}" class="btn btn-light next_button mt-2">
  			...
  			<div class="col-md-6">
  				<x-card class="card_box border-0 rounded-4">
  					<img src="{{ asset('/wp-content/uploads/maintenance_card.PNG') }}"
  					...
  					<div class="card-body" style="margin-top: -30px;">
					    ...
					    <div class="d-flex justify-content-center align-items-center">
								<div class="buttons text-center">
									<a href="{{ url('https://www.goldenmindsbulacan.com/academics/basic-education') }}" title="Read more information about GMA-BE"
